...
const Form = ({ navigation }) => {
  ...
  let handleSubmit = async (e) => {
    fetch("http://172.23.36.8:3000/api/log", {
      method: "POST",
      headers: {
  ...
  const radio_props = [
    {
      label: (
        <View style={{ marginRight: 5, paddingHorizontal: 5 }}>
          <Text style={{ color: "#FFFFFF", fontSize: 20, marginEnd: 10 }}>
            {"In"}
          </Text>
        </View>
      ),
    ...
    {
      label: <Text style={{ color: "#FFFFFF", fontSize: 18 }}>{"Out"}</Text>,
      value: "Out",
    },
  ];
            ...
            <View style={styles.main}>
              ...
              >
                ...
                <TouchableOpacity onPress={showDatePicker}>
                  ...
                  >
                    <Text
                      style={{ color: "#FFFFFF", fontSize: 16, marginTop: 8 }}
                    >
                      {datetime}
                    </Text>
                  </View>
              ...
              >
                ...
                <TouchableOpacity style={styles.button}>
                  <View>
                    <Text
                      style={[styles.text, { lineHeight: 45 }]}
